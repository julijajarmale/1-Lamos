...
function Create() {
    ...
    const handleCreate = () => {
        const data = { title, price: parseFloat(price), inStock: inStock? 1: 0, cat: parseInt(cat)}; // kaip issiunciama
        setCreateProduct(data);
        setTitle('');   //cia viska nunulinam
        setPrice('');
        setInStock(false);
        setCat('0')
        ...
        <div className="card mt-4">
            ...
            <div className="card-body">
                ...
                <div className="form-group">
                    ...
                    <small className="form-text text-muted">Enter product price here.</small>
                </div>
